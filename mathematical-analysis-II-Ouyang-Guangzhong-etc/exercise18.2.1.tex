...
\begin{CJK}{UTF8}{gkai}
  ...
  %	ESSAY BODY
  % ----------------------------------------------------------------------------------------
  \begin{exercise}[18.2.1]
证明下面积分在所给定区间内一致收敛.
$$
\int_0^{+\infty}\frac{\cos xy}{x^2+y^2}dx(y\geq a>0);
$$
  \end{exercise}
  \begin{proof}[证明]
易知 $\forall y\geq a$,我们有
$$
|\frac{\cos xy}{x^2+y^2}|\leq \frac{1}{x^2}.
$$
我们知道,
$$
\int_0^{+\infty}\frac{1}{x^2}
$$
是收敛的,因此,根据 Weierstrass 判别法,在给定区间内题目中的积分一致收敛.
  \end{proof}
  % ----------------------------------------------------------------------------------------
  %	BIBLIOGRAPHY
  % ----------------------------------------------------------------------------------------
